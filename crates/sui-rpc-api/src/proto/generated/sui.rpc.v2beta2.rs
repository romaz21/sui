...
pub mod ledger_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn get_object(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/sui.rpc.v2beta2.LedgerService/GetObject");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "sui.rpc.v2beta2.LedgerService",
                "GetObject",
        ...
        pub async fn get_epoch(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/sui.rpc.v2beta2.LedgerService/GetEpoch");
            let mut req = request.into_request();
            req.extensions_mut()
...
pub mod live_data_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<super::GetBalanceResponse>, tonic::Status>
        {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/sui.rpc.v2beta2.LiveDataService/GetBalance");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "sui.rpc.v2beta2.LiveDataService",
                "GetBalance",
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/sui.rpc.v2beta2.LiveDataService/ListDynamicFields" => {
                        ...
                        for ListDynamicFieldsSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LiveDataService>::list_dynamic_fields(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/sui.rpc.v2beta2.LiveDataService/ListOwnedObjects" => {
                        ...
                        for ListOwnedObjectsSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LiveDataService>::list_owned_objects(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/sui.rpc.v2beta2.LiveDataService/GetCoinInfo" => {
                    ...
                    impl<T: LiveDataService> tonic::server::UnaryService<super::GetCoinInfoRequest>
                ...
                "/sui.rpc.v2beta2.LiveDataService/GetBalance" => {
                    ...
                    impl<T: LiveDataService> tonic::server::UnaryService<super::GetBalanceRequest>
                        for GetBalanceSvc<T>
                    {
                ...
                "/sui.rpc.v2beta2.LiveDataService/ListBalances" => {
                    ...
                    impl<T: LiveDataService> tonic::server::UnaryService<super::ListBalancesRequest>
                ...
                "/sui.rpc.v2beta2.LiveDataService/SimulateTransaction" => {
                        ...
                        for SimulateTransactionSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LiveDataService>::simulate_transaction(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
...
pub struct ValidatorSet {
    ...
    pub at_risk_validators: ::std::collections::HashMap<::prost::alloc::string::String, u64>,
    /// Any extra fields that's not defined statically.
    #[prost(message, optional, tag = "9")]
    pub extra_fields: ::core::option::Option<MoveTable>,
}
